...
public class DustServiceImp implements IDustService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.yz.service.imp.IDustServiceImp#getPageCount(int,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.yz.service.imp.IDustServiceImp#getTotalCount(int,
	 *      java.lang.String)
	 */
	public int getTotalCount(int con, String convalue, int projectId) {
		String queryString = "select count(*) from Dust mo where 1=1 and mo.projectId ="
				+ projectId;
		Object[] p = null;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.yz.service.imp.IDustServiceImp#queryList(int, java.lang.String,
	 *      int, int)
	 */
	public List<Dust> queryList(int con, String convalue, int projectId,
			int page, int size) {
		String queryString = "from Dust mo where 1=1 and mo.projectId ="
				+ projectId;
		Object[] p = null;
		if (con != 0 && convalue != null && !convalue.equals("")) {
			if (con == 1) {
	...
	public List<Dust> getDustsByLimit() {
		// TODO Auto-generated method stub
		String queryString = "from Dust mo  order by id desc";
		return dustDao.getObjectsByLimit(queryString);
	}
