...
public class DustServiceImp implements IDustService {
	...
	public int getTotalCount(int con, String convalue, int projectId) {
		String queryString = "select count(*) from Dust mo where 1=1 and mo.projectId ="+projectId;
		Object[] p = null;
	 ...
	 */
	public List<Dust> queryList(int con, String convalue, int projectId, int page, int size) {
		String queryString = "from Dust mo where 1=1 and mo.projectId ="+projectId;
		Object[] p = null;
		if(con!=0&&convalue!=null&&!convalue.equals("")){
			if(con==1){
				queryString += "and mo.unit.name like ? "; 
